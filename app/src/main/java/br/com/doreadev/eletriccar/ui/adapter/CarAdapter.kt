...
class CarAdapter(private val carros: List<Carro>): RecyclerView.Adapter<CarAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        init {
            view.apply {
                preco = findViewById(R.id.tv_precoValueId)
                bateria = findViewById(R.id.tv_bateriaValueId)
                potencia = findViewById(R.id.tv_potenciaValueId)
                recarga = findViewById(R.id.tv_recargaValueId)
            }
        }
    }
}
